...
export default function ConfirmationDialog({ title, body, open, onConfirmAction, onCancelAction, cancelLabel, confirmLabel }: any): any {
                    ...
                    <Box pt={3} pb={3} px={3}>
                        ...
                        <Stack direction="row" spacing={2} sx={{ display: "flex", justifyContent: "flex-end" }}>
                            <Button
                                ...
                                sx={{ innerWidth: "10",backgroundColor: "#e41a0e", color: 'black', fontWeight: "700", ':hover': {
                                    boxShadow: 10,
